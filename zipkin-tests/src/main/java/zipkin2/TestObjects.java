...
public final class TestObjects {
  ...
  public static long startTs(List<Span> trace) {
    return trace.get(0).timestampAsLong() / 1000;
  }

  public static long endTs(List<Span> trace) {
    return startTs(trace) + trace.get(0).durationAsLong() / 1000;
  }
  ...
  public static Span span(long traceId) {
    return SPAN_BUILDER.traceId(Long.toHexString(traceId)).id(traceId).build();
  }
